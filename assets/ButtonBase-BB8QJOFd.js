import{r as a,O as A,h as W,_ as te,o as T,j as $,e as be,a0 as ne,k as oe,m as ge,W as Oe,g as Ie,K as ce,M as Ue,q as ze}from"./index-DNxSeVs6.js";const Ke=typeof window<"u"?a.useLayoutEffect:a.useEffect;function H(e){const t=a.useRef(e);return Ke(()=>{t.current=e}),a.useRef((...s)=>(0,t.current)(...s)).current}function Z(e,t){return Z=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(l,n){return l.__proto__=n,l},Z(e,t)}function Ae(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,Z(e,t)}const pe=A.createContext(null);function We(e){if(e===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function ie(e,t){var s=function(o){return t&&a.isValidElement(o)?t(o):o},l=Object.create(null);return e&&a.Children.map(e,function(n){return n}).forEach(function(n){l[n.key]=s(n)}),l}function Xe(e,t){e=e||{},t=t||{};function s(d){return d in t?t[d]:e[d]}var l=Object.create(null),n=[];for(var o in e)o in t?n.length&&(l[o]=n,n=[]):n.push(o);var i,c={};for(var u in t){if(l[u])for(i=0;i<l[u].length;i++){var p=l[u][i];c[l[u][i]]=s(p)}c[u]=s(u)}for(i=0;i<n.length;i++)c[n[i]]=s(n[i]);return c}function _(e,t,s){return s[t]!=null?s[t]:e.props[t]}function Ye(e,t){return ie(e.children,function(s){return a.cloneElement(s,{onExited:t.bind(null,s),in:!0,appear:_(s,"appear",e),enter:_(s,"enter",e),exit:_(s,"exit",e)})})}function He(e,t,s){var l=ie(e.children),n=Xe(t,l);return Object.keys(n).forEach(function(o){var i=n[o];if(a.isValidElement(i)){var c=o in t,u=o in l,p=t[o],d=a.isValidElement(p)&&!p.props.in;u&&(!c||d)?n[o]=a.cloneElement(i,{onExited:s.bind(null,i),in:!0,exit:_(i,"exit",e),enter:_(i,"enter",e)}):!u&&c&&!d?n[o]=a.cloneElement(i,{in:!1}):u&&c&&a.isValidElement(p)&&(n[o]=a.cloneElement(i,{onExited:s.bind(null,i),in:p.props.in,exit:_(i,"exit",e),enter:_(i,"enter",e)}))}}),n}var Ge=Object.values||function(e){return Object.keys(e).map(function(t){return e[t]})},qe={component:"div",childFactory:function(t){return t}},re=function(e){Ae(t,e);function t(l,n){var o;o=e.call(this,l,n)||this;var i=o.handleExited.bind(We(o));return o.state={contextValue:{isMounting:!0},handleExited:i,firstRender:!0},o}var s=t.prototype;return s.componentDidMount=function(){this.mounted=!0,this.setState({contextValue:{isMounting:!1}})},s.componentWillUnmount=function(){this.mounted=!1},t.getDerivedStateFromProps=function(n,o){var i=o.children,c=o.handleExited,u=o.firstRender;return{children:u?Ye(n,c):He(n,i,c),firstRender:!1}},s.handleExited=function(n,o){var i=ie(this.props.children);n.key in i||(n.props.onExited&&n.props.onExited(o),this.mounted&&this.setState(function(c){var u=W({},c.children);return delete u[n.key],{children:u}}))},s.render=function(){var n=this.props,o=n.component,i=n.childFactory,c=te(n,["component","childFactory"]),u=this.state.contextValue,p=Ge(this.state.children).map(i);return delete c.appear,delete c.enter,delete c.exit,o===null?A.createElement(pe.Provider,{value:u},p):A.createElement(pe.Provider,{value:u},A.createElement(o,c,p))},t}(A.Component);re.propTypes={};re.defaultProps=qe;const Je=re;function Qe(e){const{className:t,classes:s,pulsate:l=!1,rippleX:n,rippleY:o,rippleSize:i,in:c,onExited:u,timeout:p}=e,[d,g]=a.useState(!1),b=T(t,s.ripple,s.rippleVisible,l&&s.ripplePulsate),C={width:i,height:i,top:-(i/2)+o,left:-(i/2)+n},h=T(s.child,d&&s.childLeaving,l&&s.childPulsate);return!c&&!d&&g(!0),a.useEffect(()=>{if(!c&&u!=null){const R=setTimeout(u,p);return()=>{clearTimeout(R)}}},[u,c,p]),$.jsx("span",{className:b,style:C,children:$.jsx("span",{className:h})})}const m=be("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),Ze=["center","classes","className"];let G=e=>e,fe,de,he,me;const ee=550,et=80,tt=ne(fe||(fe=G`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
